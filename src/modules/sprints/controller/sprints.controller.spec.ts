...
describe('SprintsController', () => {
  ...
  const mockFindSprintApplication = { findAllSprintByProject: jest.fn(), findTasksBySprint: jest.fn(), getSprintProgress: jest.fn() };
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: SPRINT_TYPES.applications.CreateSprintApplication, useValue: mockCreateSprintApplication },
        { provide: SPRINT_TYPES.applications.FindSprintApplication, useValue: mockFindSprintApplication },
        { provide: SPRINT_TYPES.applications.StartSprintApplication, useValue: mockStartSprintApplication },
        { provide: SPRINT_TYPES.applications.CompleteSprintApplication, useValue: mockCompleteSprintApplication },
  ...
  describe('create', () => {
    it('should call create application', async () => {
      ...
      const result = await controller.create('ws-1', 'proj-1', {} as any, { id: 'user-1' } as any);
  ...
  describe('findAllSprintByProject', () => {
    it('should call findAllSprintByProject application', async () => {
      mockFindSprintApplication.findAllSprintByProject.mockResolvedValue([{ id: 'sprint-1' }]);
      const result = await controller.findAllSprintByProject('ws-1', 'proj-1', { keyword: 'test' } as any, { id: 'user-1' } as any);
      expect(result).toEqual([{ id: 'sprint-1' }]);
      expect(mockFindSprintApplication.findAllSprintByProject).toHaveBeenCalled();
    });
  });

  describe('findTasksBySprint', () => {
    it('should call findTasksBySprint application', async () => {
      mockFindSprintApplication.findTasksBySprint.mockResolvedValue({ id: 'sprint-1' });
      const result = await controller.findTasksBySprint('ws-1', 'proj-1', 'sprint-1', { id: 'user-1' } as any);
      expect(result).toEqual({ id: 'sprint-1' });
  ...
  describe('getSprintDetail', () => {
    it('should call getSprintDetail application', async () => {
      mockGetSprintDetailApplication.getSprintDetail.mockResolvedValue({ id: 'sprint-1' });
      const result = await controller.getSprintDetail('ws-1', 'proj-1', 'sprint-1');
      expect(result).toEqual({ id: 'sprint-1' });
  ...
  describe('startSprint', () => {
    it('should call start application', async () => {
      ...
      const result = await controller.startSprint('ws-1', 'proj-1', 'sprint-1', {} as any, { id: 'user-1' } as any);
      expect(result).toEqual({ id: 'sprint-1' });
  ...
  describe('completeSprint', () => {
    it('should call complete application', async () => {
      mockCompleteSprintApplication.complete.mockResolvedValue({ id: 'sprint-1' });
      const result = await controller.completeSprint('ws-1', 'proj-1', 'sprint-1', { id: 'user-1' } as any);
      expect(result).toEqual({ id: 'sprint-1' });
  ...
  describe('cancelSprint', () => {
    it('should call cancelSprint application', async () => {
      mockCancelSprintApplication.cancelSprint.mockResolvedValue({ id: 'sprint-1' });
      const result = await controller.cancelSprint('ws-1', 'proj-1', 'sprint-1', { id: 'user-1' } as any);
      expect(result).toEqual({ id: 'sprint-1' });
