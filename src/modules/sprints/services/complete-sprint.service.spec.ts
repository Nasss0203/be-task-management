...
describe('CompleteSprintServiceImpl', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CompleteSprintServiceImpl,
        {
          ...
          useValue: mockCompleteSprintRepository,
        },
        {
        ...
        },
        {
          ...
          useValue: mockMoveUnfinishedTasksToBacklogService,
        },
        {
        ...
        },
        {
          ...
          useValue: mockMarkDoneTasksCompletedAtInSprintService,
        },
        {
          provide:
            SPRINT_REPORT_TYPES.repositories.CreateSprintReportRepository,
          useValue: mockCreateSprintReportRepository,
        },
      ],
    }).compile();
  ...
  describe('completeSprint', () => {
    ...
    it('should throw error and rollback if create sprint report fails', async () => {
      ...
      mockFindTaskStatusRepository.findDoneStatus.mockResolvedValue({
        id: 'done-status',
      });
      ...
      expect(
        mockMoveUnfinishedTasksToBacklogService.move,
      ).not.toHaveBeenCalled();
      expect(
        mockCompleteSprintRepository.completeSprint,
      ).not.toHaveBeenCalled();
    });
    ...
    it('should calculate sprint report summary and complete sprint', async () => {
      ...
      mockCreateSprintReportRepository.create.mockResolvedValue(undefined);
      mockCompleteSprintRepository.completeSprint.mockResolvedValue({
        id: 'sprint-1',
      });
      ...
      expect(
        mockMarkDoneTasksCompletedAtInSprintService.mark,
      ).toHaveBeenCalled();
