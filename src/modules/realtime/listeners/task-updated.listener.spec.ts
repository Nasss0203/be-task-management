...
import { TaskUpdatedRealtimeListener } from './task-updated.listener';
...
describe('TaskUpdatedRealtimeListener', () => {
  let provider: TaskUpdatedRealtimeListener;
  ...
  beforeEach(async () => {
    ...
    provider = module.get<TaskUpdatedRealtimeListener>(TaskUpdatedRealtimeListener);
  });
