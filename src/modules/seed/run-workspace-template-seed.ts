...
async function bootstrap() {
  ...
  const pageTemplatesData = [
    {
      ...
      blocks: [
        {
          type: 'HEADING_1',
          content: { text: '🚀 Welcome to Software Engineering' },
          orderIndex: 1,
        },
        {
          type: 'TEXT',
          content: {
            text: 'Here is your sprint board and backlog. Keep up the good work!',
          },
          orderIndex: 2,
        },
        ...
        {
          type: 'DATABASE_VIEW',
          content: { boardTemplateKey: 'fe-board', title: 'Frontend Sprint' },
          orderIndex: 5,
        },
        { type: 'HEADING_2', content: { text: 'Backend' }, orderIndex: 6 },
        {
          type: 'DATABASE_VIEW',
          content: { boardTemplateKey: 'be-board', title: 'Backend Sprint' },
          orderIndex: 7,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'HEADING_1',
          content: { text: '📢 Marketing Campaigns' },
          orderIndex: 1,
        },
        {
          type: 'TEXT',
          content: { text: 'Manage all your content in one place.' },
          orderIndex: 2,
        },
        {
          type: 'DATABASE_VIEW',
          content: { boardTemplateKey: 'kanban', title: 'Kanban View' },
          orderIndex: 3,
        },
        {
          type: 'DATABASE_VIEW',
          content: { boardTemplateKey: 'calendar', title: 'Calendar View' },
          orderIndex: 4,
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'TEXT',
          content: { text: 'Start adding boards, views, and pages here.' },
          orderIndex: 2,
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'DATABASE_VIEW',
          content: { boardTemplateKey: 'main-board', title: 'Task List' },
          orderIndex: 2,
        },
      ],
    },
  ...
  for (const ptData of pageTemplatesData) {
    ...
    if (!pt) {
      pt = await pageTemplateRepo.save(
        pageTemplateRepo.create({
          name: ptData.name,
      ...
      const blocks = ptData.blocks.map((b) =>
        pageTemplateBlockRepo.create({
          templateId: pt!.id,
          type: b.type as any,
          content: b.content,
  ...
  const templates = [
    {
      ...
      description:
        'Template for software development teams with Backlog, Sprint, and Bug Tracking.',
      ...
      config: {
        ...
        boards: [
          {
            templateKey: 'fe-board',
            projectTemplateKey: 'frontend',
            name: 'Sprint Board',
            viewType: BoardViewType.BOARD,
          },
          {
            templateKey: 'fe-backlog',
            projectTemplateKey: 'frontend',
            name: 'Backlog',
            viewType: BoardViewType.LIST,
          },
          {
            templateKey: 'be-board',
            projectTemplateKey: 'backend',
            name: 'Sprint Board',
            viewType: BoardViewType.BOARD,
          },
        ],
    ...
    },
    {
      ...
      description:
        'Start from scratch with a completely blank workspace to customize exactly how you want.',
      category: 'General',
      coverUrl: null,
      isSystem: true,
      ...
      visibility: TemplateVisibility.PUBLIC,
      config: {
        projects: [{ templateKey: 'general', name: 'General', key: 'GEN' }],
        boards: [
          {
            templateKey: 'main-board',
            projectTemplateKey: 'general',
            name: 'Main Board',
            viewType: BoardViewType.BOARD,
          },
        ],
    ...
    },
    {
      ...
      description:
        'A lightweight workspace optimized for individual productivity and daily task tracking.',
      ...
      visibility: TemplateVisibility.PUBLIC,
      config: {
        projects: [{ templateKey: 'personal', name: 'My Tasks', key: 'ME' }],
        boards: [
          {
            templateKey: 'main-board',
            projectTemplateKey: 'personal',
            name: 'To-do List',
            viewType: BoardViewType.LIST,
          },
          {
  ...
  for (const t of templates) {
    const existing = await workspaceTemplateRepo.findOne({
      where: { name: t.name },
    });
    if (!existing) {
