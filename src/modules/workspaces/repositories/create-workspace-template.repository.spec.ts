...
import { CreateWorkspaceTemplateRepositoryImpl } from './create-workspace-template.repository';
...
describe('CreateWorkspaceTemplateRepositoryImpl', () => {
  let provider: CreateWorkspaceTemplateRepositoryImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CreateWorkspaceTemplateRepositoryImpl,
        {
    ...
    provider = module.get<CreateWorkspaceTemplateRepositoryImpl>(CreateWorkspaceTemplateRepositoryImpl);
  });
