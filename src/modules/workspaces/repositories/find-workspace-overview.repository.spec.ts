...
import { FindWorkspaceOverviewRepositoryImpl } from './find-workspace-overview.repository';
...
describe('FindWorkspaceOverviewRepositoryImpl', () => {
  let provider: FindWorkspaceOverviewRepositoryImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        FindWorkspaceOverviewRepositoryImpl,
        {
          provide: DataSource,
          useValue: {
    ...
    provider = module.get<FindWorkspaceOverviewRepositoryImpl>(FindWorkspaceOverviewRepositoryImpl);
  });
