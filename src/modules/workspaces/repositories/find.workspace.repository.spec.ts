...
import { FindWorkspaceRepositoryImpl } from './find.workspace.repository';
...
describe('FindWorkspaceRepositoryImpl', () => {
  let provider: FindWorkspaceRepositoryImpl;
  ...
  beforeEach(async () => {
    ...
    provider = module.get<FindWorkspaceRepositoryImpl>(FindWorkspaceRepositoryImpl);
  });
  ...
  describe('findWorkspacesByUserId', () => {
    it('should execute successfully', async () => {
      try {
        await provider.findWorkspacesByUserId({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
