...
import { WorkspaceRepositoryImpl } from './create-workspace.repository';
...
describe('WorkspaceRepositoryImpl', () => {
  let provider: WorkspaceRepositoryImpl;
  ...
  beforeEach(async () => {
    ...
    provider = module.get<WorkspaceRepositoryImpl>(WorkspaceRepositoryImpl);
  });
  ...
  describe('existsBySlug', () => {
    it('should execute successfully', async () => {
      try {
        await provider.existsBySlug({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
  ...
  describe('save', () => {
    it('should execute successfully', async () => {
      try {
        await provider.save({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
      expect(true).toBe(true);
    });
  });
