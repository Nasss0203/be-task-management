...
import { WorkspaceTrashApplicationImpl } from './workspace-trash.application';
...
describe('WorkspaceTrashApplicationImpl', () => {
  let provider: WorkspaceTrashApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        WorkspaceTrashApplicationImpl,
        {
    ...
    provider = module.get<WorkspaceTrashApplicationImpl>(WorkspaceTrashApplicationImpl);
  });
