...
import { AdminFindAllWorkspaceApplicationImpl } from './admin-findAll-workspace.application';
...
describe('AdminFindAllWorkspaceApplicationImpl', () => {
  let provider: AdminFindAllWorkspaceApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminFindAllWorkspaceApplicationImpl,
        {
    ...
    provider = module.get<AdminFindAllWorkspaceApplicationImpl>(AdminFindAllWorkspaceApplicationImpl);
  });
