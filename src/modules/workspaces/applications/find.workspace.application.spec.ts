...
import { FindWorkspaceApplicationImpl } from './find.workspace.application';
...
describe('FindWorkspaceApplicationImpl', () => {
  let provider: FindWorkspaceApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        FindWorkspaceApplicationImpl,
        {
    ...
    provider = module.get<FindWorkspaceApplicationImpl>(FindWorkspaceApplicationImpl);
  });
  ...
  describe('findAllByUserId', () => {
    it('should execute successfully', async () => {
      try {
        await provider.findAllByUserId({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
