...
import { AccessWorkspaceApplicationImpl } from './access-workspace.application';
...
describe('AccessWorkspaceApplicationImpl', () => {
  let provider: AccessWorkspaceApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AccessWorkspaceApplicationImpl,
        {
    ...
    provider = module.get<AccessWorkspaceApplicationImpl>(
      AccessWorkspaceApplicationImpl,
    );
  });
