...
import { CreateWorkspaceApplicationImpl } from './create-workspace.application';
...
describe('CreateWorkspaceApplicationImpl', () => {
  let provider: CreateWorkspaceApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CreateWorkspaceApplicationImpl,
        {
    ...
    provider = module.get<CreateWorkspaceApplicationImpl>(CreateWorkspaceApplicationImpl);
  });
  ...
  describe('createDeault', () => {
    it('should execute successfully', async () => {
      try {
        await provider.createDeault({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
