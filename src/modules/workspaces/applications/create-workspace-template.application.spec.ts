...
import { CreateWorkspaceTemplateApplicationImpl } from './create-workspace-template.application';
...
describe('CreateWorkspaceTemplateApplicationImpl', () => {
  let provider: CreateWorkspaceTemplateApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CreateWorkspaceTemplateApplicationImpl,
        {
    ...
    provider = module.get<CreateWorkspaceTemplateApplicationImpl>(CreateWorkspaceTemplateApplicationImpl);
  });
