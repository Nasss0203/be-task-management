...
import { UpdateWorkspaceLayoutModeApplicationImpl } from './update-workspace-layout-mode.application';
...
describe('UpdateWorkspaceLayoutModeApplicationImpl', () => {
  let provider: UpdateWorkspaceLayoutModeApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        UpdateWorkspaceLayoutModeApplicationImpl,
        {
    ...
    provider = module.get<UpdateWorkspaceLayoutModeApplicationImpl>(UpdateWorkspaceLayoutModeApplicationImpl);
  });
