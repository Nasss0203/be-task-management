...
describe('WorkspacesController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide:
            WORKSPACE_TYPES.applications.CreateWorkspaceTemplateApplication,
          useValue: {
            create: jest.fn().mockResolvedValue({}),
            find: jest.fn().mockResolvedValue([]),
            findOne: jest.fn().mockResolvedValue({}),
        ...
        {
          provide:
            WORKSPACE_TYPES.applications.SaveWorkspaceAsTemplateApplication,
  ...
  describe('createByTemplate', () => {
    it('should execute successfully', async () => {
      try {
        await provider.createByTemplate(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
  ...
  describe('findAllWorkspace', () => {
    it('should execute successfully', async () => {
      try {
        await provider.findAllWorkspace(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
  ...
  describe('findDeletedWorkspaces', () => {
    it('should execute successfully', async () => {
      try {
        await provider.findDeletedWorkspaces(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
  ...
  describe('findOneWorkspaceById', () => {
    it('should execute successfully', async () => {
      try {
        await provider.findOneWorkspaceById(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
  ...
  describe('getWorkspaceAccess', () => {
    it('should execute successfully', async () => {
      try {
        await provider.getWorkspaceAccess(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
  ...
  describe('updateLayoutMode', () => {
    it('should execute successfully', async () => {
      try {
        await provider.updateLayoutMode(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
  ...
  describe('updateWorkspace', () => {
    it('should execute successfully', async () => {
      try {
        await provider.updateWorkspace(
          {} as any,
          {} as any,
          {} as any,
          {} as any,
