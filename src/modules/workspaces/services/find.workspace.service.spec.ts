...
describe('FindWorkspaceServiceImpl', () => {
  let provider: FindWorkspaceServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        FindWorkspaceServiceImpl,
        {
    ...
    provider = module.get<FindWorkspaceServiceImpl>(FindWorkspaceServiceImpl);
  });
  ...
  describe('findOneByWorkspaceId', () => {
    it('should execute successfully', async () => {
      try {
        await provider.findOneByWorkspaceId({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
      expect(true).toBe(true);
    });
  });
