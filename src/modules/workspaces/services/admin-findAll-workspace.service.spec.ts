...
describe('AdminFindAllWorkspaceServiceImpl', () => {
  let provider: AdminFindAllWorkspaceServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminFindAllWorkspaceServiceImpl,
        {
    ...
    provider = module.get<AdminFindAllWorkspaceServiceImpl>(AdminFindAllWorkspaceServiceImpl);
  });
