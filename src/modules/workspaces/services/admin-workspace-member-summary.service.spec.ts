...
describe('AdminWorkspaceMemberSummaryServiceImpl', () => {
  let provider: AdminWorkspaceMemberSummaryServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminWorkspaceMemberSummaryServiceImpl,
        {
          provide: WORKSPACE_TYPES.repositories.AdminWorkspaceMemberSummaryRepository,
          useValue: {
    ...
    provider = module.get<AdminWorkspaceMemberSummaryServiceImpl>(AdminWorkspaceMemberSummaryServiceImpl);
  });
