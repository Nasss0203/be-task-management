...
describe('FindWorkspaceOverviewServiceImpl', () => {
  let provider: FindWorkspaceOverviewServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        FindWorkspaceOverviewServiceImpl,
        {
    ...
    provider = module.get<FindWorkspaceOverviewServiceImpl>(FindWorkspaceOverviewServiceImpl);
  });
