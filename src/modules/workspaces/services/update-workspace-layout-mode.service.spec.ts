...
describe('UpdateWorkspaceLayoutModeServiceImpl', () => {
  let provider: UpdateWorkspaceLayoutModeServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        UpdateWorkspaceLayoutModeServiceImpl,
        {
    ...
    provider = module.get<UpdateWorkspaceLayoutModeServiceImpl>(UpdateWorkspaceLayoutModeServiceImpl);
  });
