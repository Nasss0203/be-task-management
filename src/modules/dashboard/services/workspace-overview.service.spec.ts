...
import { WorkspaceOverviewServiceImpl } from './workspace-overview.service';
...
describe('WorkspaceOverviewServiceImpl', () => {
  let provider: WorkspaceOverviewServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        WorkspaceOverviewServiceImpl,
        {
    ...
    provider = module.get<WorkspaceOverviewServiceImpl>(WorkspaceOverviewServiceImpl);
  });
