...
import { DashboardSuggestionsServiceImpl } from './dashboard-suggestions.service';
...
describe('DashboardSuggestionsServiceImpl', () => {
  let provider: DashboardSuggestionsServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        DashboardSuggestionsServiceImpl,
        {
    ...
    provider = module.get<DashboardSuggestionsServiceImpl>(DashboardSuggestionsServiceImpl);
  });
  ...
  describe('getSuggestions', () => {
    it('should execute successfully', async () => {
      try {
        await provider.getSuggestions({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
