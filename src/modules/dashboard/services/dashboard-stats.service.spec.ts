...
import { DashboardStatsServiceImpl } from './dashboard-stats.service';
...
describe('DashboardStatsServiceImpl', () => {
  let provider: DashboardStatsServiceImpl;
  ...
  beforeEach(async () => {
    ...
    provider = module.get<DashboardStatsServiceImpl>(DashboardStatsServiceImpl);
  });
  ...
  describe('getStats', () => {
    it('should execute successfully', async () => {
      try {
        await provider.getStats({} as any, {} as any, {} as any, {} as any);
      } catch (e) {}
