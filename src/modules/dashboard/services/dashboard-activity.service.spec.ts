...
import { DashboardActivityServiceImpl } from './dashboard-activity.service';
...
describe('DashboardActivityServiceImpl', () => {
  let provider: DashboardActivityServiceImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        DashboardActivityServiceImpl,
        {
    ...
    provider = module.get<DashboardActivityServiceImpl>(DashboardActivityServiceImpl);
  });
  ...
  describe('getRecentActivities', () => {
    it('should execute successfully', async () => {
      try {
        await provider.getRecentActivities({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
