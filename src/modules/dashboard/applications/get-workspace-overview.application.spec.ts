...
import { GetWorkspaceOverviewApplicationImpl } from './get-workspace-overview.application';
...
describe('GetWorkspaceOverviewApplicationImpl', () => {
  let provider: GetWorkspaceOverviewApplicationImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        GetWorkspaceOverviewApplicationImpl,
        {
    ...
    provider = module.get<GetWorkspaceOverviewApplicationImpl>(GetWorkspaceOverviewApplicationImpl);
  });
  ...
  describe('getOverview', () => {
    it('should execute successfully', async () => {
      try {
        await provider.getOverview({} as any, {} as any, {} as any, {} as any);
      } catch(e) {}
