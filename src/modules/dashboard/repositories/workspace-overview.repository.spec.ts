...
import { WorkspaceOverviewRepositoryImpl } from './workspace-overview.repository';
...
describe('WorkspaceOverviewRepositoryImpl', () => {
  let provider: WorkspaceOverviewRepositoryImpl;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        WorkspaceOverviewRepositoryImpl,
        {
          provide: DataSource,
          useValue: {
    ...
    provider = module.get<WorkspaceOverviewRepositoryImpl>(WorkspaceOverviewRepositoryImpl);
  });
