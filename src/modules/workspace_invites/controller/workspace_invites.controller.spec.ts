...
describe('WorkspaceInvitesController', () => {
  ...
  beforeEach(async () => {
      ...
      providers: [
        {
          ...
          useValue: mockCreateLinkApp,
        },
        {
          provide:
            WORKSPACE_INVITE_TYPES.applications
              .InviteWorkspaceMemberApplication,
          useValue: mockInviteApp,
        },
        {
          provide:
            WORKSPACE_INVITE_TYPES.applications.SearchInviteUsersApplication,
          useValue: mockSearchApp,
        },
        {
          provide:
            WORKSPACE_INVITE_TYPES.applications
    ...
    controller = module.get<WorkspaceInvitesController>(
  ...
  it('should invite user', async () => {
    ...
    expect(mockInviteApp.invite).toHaveBeenCalledWith('ws-1', 'u-1', {
      role_name: 'MEMBER',
    });
