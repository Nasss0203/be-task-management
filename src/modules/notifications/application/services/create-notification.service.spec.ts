...
import { CreateNotificationServiceImpl } from './create-notification.service';
...
describe('CreateNotificationServiceImpl', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<CreateNotificationServiceImpl>(
      CreateNotificationServiceImpl,
    );
  });
  ...
  it('should create notification', async () => {
    mockRepo.saveNotification.mockResolvedValue({
      id: '1',
      title: 'test',
      type: NotificationType.WORKSPACE_INVITE,
    });
