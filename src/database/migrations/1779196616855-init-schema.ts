...
export class InitSchema1779196616855 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8385e7e4b0c91cfa308cba3f13"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_91fa0aebab77f3ac7568a364da"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "receiver_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_sender_type_enum" AS ENUM('SYSTEM', 'USER')`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "sender_type" "public"."notifications_sender_type_enum" NOT NULL DEFAULT 'SYSTEM'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_source_type_enum" AS ENUM('SYSTEM', 'ACCOUNT', 'WORKSPACE', 'PROJECT', 'TASK', 'SPRINT', 'COMMENT')`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "source_type" "public"."notifications_source_type_enum" NOT NULL DEFAULT 'SYSTEM'`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "project_id" uuid`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "comment_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "action_url" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "archived_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum_old" AS ENUM('TASK_ASSIGNED', 'TASK_UNASSIGNED', 'TASK_COMMENTED', 'TASK_MENTIONED', 'TASK_DUE_SOON', 'WORKSPACE_INVITED', 'WORKSPACE_MEMBER_JOINED', 'SPRINT_STARTED', 'SPRINT_COMPLETED', 'PAGE_MENTIONED', 'PAGE_SHARED', 'SYSTEM')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP COLUMN "sprint_id"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP COLUMN "sender_type"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_entity_type_enum" AS ENUM('TASK', 'SPRINT', 'COMMENT', 'PAGE', 'WORKSPACE', 'PROJECT', 'INVITE')`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "entity_type" "public"."notifications_entity_type_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD "user_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_91fa0aebab77f3ac7568a364da" ON "notifications" ("user_id", "workspace_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8385e7e4b0c91cfa308cba3f13" ON "notifications" ("read_at", "user_id", "workspace_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d5ace4f24abe554acb1a919656" ON "notifications" ("entity_id", "entity_type") `,
    );
    await queryRunner.query(
