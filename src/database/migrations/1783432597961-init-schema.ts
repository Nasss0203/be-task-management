...
export class InitSchema1783432597961 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."ai_generation_type_enum" AS ENUM('WORKSPACE_DRAFT', 'PROJECT_DRAFT', 'TASK_DRAFT', 'WORKSPACE_TREE_DRAFT', 'DASHBOARD_INSIGHT')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."ai_generation_type_enum_old" AS ENUM('DASHBOARD_INSIGHT', 'PROJECT_DRAFT', 'SPRINT_PLAN', 'SPRINT_SUMMARY', 'TASK_DRAFT', 'WORKSPACE_DRAFT', 'WORKSPACE_TREE_DRAFT')`,
    );
    await queryRunner.query(
