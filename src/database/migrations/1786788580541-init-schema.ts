...
export class InitSchema1786788580541 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_billing_interval_enum" AS ENUM('MONTH', 'YEAR', 'LIFETIME')`);
        ...
        await queryRunner.query(`CREATE TABLE "databases" ("id" uuid NOT NULL, "page_id" uuid NOT NULL, "name" character varying(255) NOT NULL, CONSTRAINT "PK_238a190c9ace4bea3dc1896f988" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "database_property_options" ("id" uuid NOT NULL, "property_id" uuid NOT NULL, "name" character varying(255) NOT NULL, "color" character varying(50), "position" character varying(255) NOT NULL, CONSTRAINT "PK_d652b4111b571abdefdf1974b13" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."database_property_type_enum" AS ENUM('TITLE', 'TEXT', 'NUMBER', 'SELECT', 'MULTI_SELECT', 'STATUS', 'DATE', 'CHECKBOX', 'PERSON', 'URL', 'EMAIL', 'PHONE', 'FILE', 'CREATED_TIME', 'UPDATED_TIME', 'CREATED_BY')`);
        await queryRunner.query(`CREATE TABLE "database_properties" ("id" uuid NOT NULL, "database_id" uuid NOT NULL, "name" character varying(255) NOT NULL, "type" "public"."database_property_type_enum" NOT NULL, "position" character varying(255) NOT NULL, CONSTRAINT "PK_1e6e9a3327cfdf01ca0384c7b03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "database_property_options" ADD CONSTRAINT "FK_f30eb092587ab22f40678651620" FOREIGN KEY ("property_id") REFERENCES "database_properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "database_properties" ADD CONSTRAINT "FK_e17dc83975eef70518071f43d03" FOREIGN KEY ("database_id") REFERENCES "databases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "database_properties" DROP CONSTRAINT "FK_e17dc83975eef70518071f43d03"`);
        await queryRunner.query(`ALTER TABLE "database_property_options" DROP CONSTRAINT "FK_f30eb092587ab22f40678651620"`);
