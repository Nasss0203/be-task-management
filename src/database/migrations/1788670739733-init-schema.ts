...
export class InitSchema1788670739733 implements MigrationInterface {
    name = 'InitSchema1788670739733'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "page_shares" DROP CONSTRAINT "FK_page_shares_share_link_id"`);
        await queryRunner.query(`CREATE TYPE "public"."page_edit_request_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "page_edit_requests" ("id" uuid NOT NULL, "page_id" uuid NOT NULL, "page_share_id" uuid NOT NULL, "user_id" uuid NOT NULL, "status" "public"."page_edit_request_status_enum" NOT NULL, "reviewed_by" uuid, "reviewed_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_5b0050ca14890845f726c0afa95" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_page_edit_requests_status" ON "page_edit_requests" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_page_edit_requests_user_id" ON "page_edit_requests" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_page_edit_requests_page_share_id" ON "page_edit_requests" ("page_share_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_page_edit_requests_page_id" ON "page_edit_requests" ("page_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_page_edit_requests_page_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_page_edit_requests_page_share_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_page_edit_requests_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_page_edit_requests_status"`);
        await queryRunner.query(`DROP TABLE "page_edit_requests"`);
        await queryRunner.query(`DROP TYPE "public"."page_edit_request_status_enum"`);
        await queryRunner.query(`ALTER TABLE "page_shares" ADD CONSTRAINT "FK_page_shares_share_link_id" FOREIGN KEY ("share_link_id") REFERENCES "page_share_links"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
