...
export class InitSchema1789659900943 implements MigrationInterface {
    name = 'InitSchema1789659900943'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."page_share_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`);
        await queryRunner.query(`ALTER TABLE "page_shares" ADD "status" "public"."page_share_status_enum" NOT NULL DEFAULT 'PENDING'`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_page_shares_status" ON "page_shares" ("status") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_page_shares_status"`);
        ...
        await queryRunner.query(`ALTER TABLE "page_shares" DROP COLUMN "status"`);
        await queryRunner.query(`DROP TYPE "public"."page_share_status_enum"`);
    }
