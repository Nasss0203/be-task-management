...
export class AddTaskPositions1784383200000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task_positions" ADD CONSTRAINT "FK_TASK_POSITION_TASK" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "task_positions" DROP CONSTRAINT "FK_TASK_POSITION_TASK"`);
