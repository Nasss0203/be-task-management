...
export class InitSchema1787904390507 implements MigrationInterface {
    name = 'InitSchema1787904390507'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "attachments" ADD "page_block_id" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "attachments" DROP COLUMN "page_block_id"`);
    }
