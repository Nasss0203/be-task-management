...
export class InitSchema1788532282857 implements MigrationInterface {
    name = 'InitSchema1788532282857'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."resource_access_level_enum" AS ENUM('VIEWER', 'COMMENTER', 'EDITOR')`);
        await queryRunner.query(`CREATE TABLE "page_shares" ("id" uuid NOT NULL, "page_id" uuid NOT NULL, "user_id" uuid NOT NULL, "access_level" "public"."resource_access_level_enum" NOT NULL, "created_by" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_page_shares_page_user" UNIQUE ("page_id", "user_id"), CONSTRAINT "PK_ceb630b1d5540981f7be503b028" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_page_shares_created_by" ON "page_shares" ("created_by") `);
        await queryRunner.query(`CREATE INDEX "IDX_page_shares_user_id" ON "page_shares" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_page_shares_page_id" ON "page_shares" ("page_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_page_shares_page_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_page_shares_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_page_shares_created_by"`);
        await queryRunner.query(`DROP TABLE "page_shares"`);
        await queryRunner.query(`DROP TYPE "public"."resource_access_level_enum"`);
    }
