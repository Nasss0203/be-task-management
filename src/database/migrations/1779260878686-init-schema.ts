...
export class InitSchema1779260878686 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoices" ADD "plan_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD "period_start" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD "period_end" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "plan_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "target_workspace_id" uuid`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "order_code" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "provider_order_id" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "provider_request_id" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "provider_transaction_id" character varying(255)`);
        await queryRunner.query(`CREATE TYPE "public"."payments_payment_method_enum" AS ENUM('QR', 'ATM', 'VISA', 'BANK_TRANSFER', 'WALLET', 'UNKNOWN')`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "payment_method" "public"."payments_payment_method_enum" NOT NULL DEFAULT 'UNKNOWN'`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "payment_url" text`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "expired_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "billing_webhooks" ADD "target_workspace_id" uuid`);
        await queryRunner.query(`ALTER TABLE "billing_webhooks" ADD "order_code" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "billing_webhooks" ADD "provider_transaction_id" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "plans" DROP CONSTRAINT "UQ_e7b71bb444e74ee067df057397e"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4e80d5a85da612468d8158f506"`);
        await queryRunner.query(`CREATE TYPE "public"."billing_webhooks_provider_enum_old" AS ENUM('MANUAL', 'VISA', 'MOMO', 'VNPAY')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_2f7b512cb530d7ecbf1bc11140" ON "billing_webhooks" ("provider", "provider_event_id") `);
        await queryRunner.query(`CREATE TYPE "public"."payments_provider_enum_old" AS ENUM('MANUAL', 'VISA', 'MOMO', 'VNPAY')`);
        await queryRunner.query(`ALTER TABLE "payments" ALTER COLUMN "provider" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_provider_enum_old" AS ENUM('MANUAL', 'VISA', 'MOMO', 'VNPAY')`);
        await queryRunner.query(`ALTER TABLE "subscriptions" ALTER COLUMN "provider" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4e80d5a85da612468d8158f506" ON "subscriptions" ("provider", "provider_subscription_id") `);
        await queryRunner.query(`ALTER TABLE "plans" ADD CONSTRAINT "UQ_e7b71bb444e74ee067df057397e" UNIQUE ("slug")`);
        await queryRunner.query(`ALTER TABLE "billing_webhooks" DROP COLUMN "provider_transaction_id"`);
        await queryRunner.query(`ALTER TABLE "billing_webhooks" DROP COLUMN "order_code"`);
        await queryRunner.query(`ALTER TABLE "billing_webhooks" DROP COLUMN "target_workspace_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "target_workspace_id"`);
